 ...
 *
 */
gxp.plugins.LayerManager_slider = Ext.extend(gxp.plugins.LayerTree, {
    ...
    createOutputConfig: function() {
        var tree = gxp.plugins.LayerManager_slider.superclass.createOutputConfig.apply(this, arguments);
    ...
    configureLayerNode: function(loader, attr) {
        gxp.plugins.LayerManager_slider.superclass.configureLayerNode.apply(this, arguments);
        var legendXType;
...
Ext.preg(gxp.plugins.LayerManager_slider.prototype.ptype, gxp.plugins.LayerManager_slider);
